...
export const certificateImages = [
  ...
  { title: "Introduction to Model Context Protocol (MCP)", issuer: "Anthropic", src: antMcp },
  { title: "Model Context Protocol: Advanced Topics", issuer: "Anthropic", src: antMcpAdvanced },
  { title: "Claude with the Anthropic API", issuer: "Anthropic", src: antClaudeApi },
  { title: "Claude with Google Vertex AI", issuer: "Anthropic", src: antClaudeVertexAi },
  ...
  { title: "Claude Code 101", issuer: "Anthropic", src: antClaudeCode101 },
  { title: "Claude Platform 101", issuer: "Anthropic", src: antClaudePlatform101 },
  ...
  { title: "Google AI Essentials (5-Course Specialization)", issuer: "Google · Coursera", src: googleAiEssentials },
  { title: "AI Fundamentals", issuer: "Google · Coursera", src: googleAiFundamentals },
  { title: "AI for Research and Insights", issuer: "Google · Coursera", src: googleAiResearchInsights },
  { title: "Inclusive Open Source Community Orientation (LFC102)", issuer: "The Linux Foundation", src: linuxFoundationLfc102 },
